...
initiating_window = pg.image.load("tictactoe/assets/modified_cover.png") 
x_img = pg.image.load("tictactoe/assets/X_modified.png") 
y_img = pg.image.load("tictactoe/assets/o_modified.png") 
